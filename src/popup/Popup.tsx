...
export const Popup = () => {
  ...
  return (
    <div className="w-[380px] p-0.5 bg-gradient-to-br from-indigo-500/20 via-purple-500/10 to-transparent rounded-3xl overflow-hidden font-sans">
      <div className="bg-white/70 backdrop-blur-3xl rounded-[22px] shadow-2xl relative overflow-hidden border border-white/40">
        ...
        <div className="px-6 mb-4">
          <div className="bg-gradient-to-br from-indigo-50/40 via-purple-50/20 to-slate-50/50 backdrop-blur-xl border border-indigo-100/40 rounded-3xl p-4 flex items-center justify-between shadow-sm shadow-indigo-100/20 animate-in fade-in duration-300">
            <div className="flex items-center gap-3.5">
              <div className="p-2.5 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-md shadow-indigo-200/50 text-white">
                {mode.icon}
              </div>
              <div>
                <p className="text-[9px] font-black text-indigo-600/70 uppercase tracking-[0.15em] leading-none mb-1.5">Fill Engine</p>
                <p className="text-[14px] font-bold text-slate-800 leading-none">
                  {mode.label}
                </p>
                <p className="text-[10px] font-semibold text-slate-400 mt-1.5 leading-none font-sans">
                  {mode.desc}
                </p>
              </div>
            </div>
            <div className={`px-2.5 py-1.5 rounded-xl border flex items-center gap-1.5 shadow-sm ${limitReached
        ...
        <div className="px-6 mb-4">
          <div className="bg-white/40 border border-white/60 rounded-2xl p-3 flex items-center justify-between shadow-sm animate-in fade-in duration-300">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[9.5px] font-semibold text-slate-400 mt-1.5 leading-none">Show shortcut panel inside forms</p>
              </div>
            </div>
            <button
        ...
        <div className="px-6 mb-4 flex justify-between gap-3">
          <div className="flex-1 bg-white/40 border border-white/60 p-3 rounded-2xl text-center">
          ...
          <div className="flex-1 bg-indigo-50/50 border border-indigo-100 p-3 rounded-2xl text-center">
        ...
        <div className="px-6 mb-5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              disabled={formFields === 0}
              className={`p-2 h-9 rounded-xl text-center text-xs font-bold border transition-all flex items-center justify-center gap-1.5 ${formFields === 0
            ...
            <button
              ...
              disabled={formFields === 0}
              className={`p-2 h-9 rounded-xl text-center text-xs font-bold border transition-all flex items-center justify-center gap-1.5 relative ${formFields === 0
                ? 'bg-slate-100/50 border-slate-200/50 text-slate-400 cursor-not-allowed'
                : persona === 'profile'
                  ? 'bg-indigo-600 border-indigo-600 text-white shadow-md shadow-indigo-200 cursor-pointer'
                  : 'bg-slate-50 border-slate-200/80 text-slate-600 hover:bg-slate-100/80 cursor-pointer'
          ...
          {persona === 'profile' && !hasProfile && formFields > 0 && (
            <div className="mt-2.5 flex items-center gap-2 text-amber-600 bg-amber-50/80 px-3.5 py-2.5 rounded-xl border border-amber-100/80 text-[10px] font-semibold animate-in fade-in duration-300">
        ...
        <div className="px-6 pb-6">
          <button
            ...
            className={`w-full group relative h-16 rounded-[20px] overflow-hidden transition-all duration-300 transform ${formFields === 0
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-3 pointer-events-none">
              {getButtonIcon()}
              <span className={`font-black text-lg tracking-tight ${formFields === 0 ? 'text-slate-400' : 'text-white'}`}>
                {getButtonText()}
              </span>
            </div>
          </button>
          ...
          <div className="flex flex-col items-center gap-2 mt-4">
            {formFields === 0 && (
              <div className="flex items-center gap-2 text-slate-500 bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-100/50 text-center text-[10.5px] font-semibold max-w-[320px] leading-normal animate-in fade-in">
            ...
            {(limitReached || errorMessage) && formFields > 0 && (
              <div className="flex items-center gap-2 text-rose-700 bg-rose-50/80 px-4 py-2.5 rounded-xl border border-rose-100 text-center text-[10px] font-bold max-w-[320px] leading-normal shadow-sm">
            ...
            {formFields > 0 && (
              <button
                ...
                className="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-all p-2 bg-slate-100/50 rounded-lg cursor-pointer animate-in fade-in"
              >
                Force Re-Scan Page
              </button>
            )}
